...
interface ThrowCompensationIntermediateEventIconProps {
  name?: string;
}

const ThrowCompensationIntermediateEventIcon: React.FC<ThrowCompensationIntermediateEventIconProps> = ({ name }) => (
...
export default ThrowCompensationIntermediateEventIcon;