...
interface NonInterruptingMessageStartEventIconProps {
  name?: string;
}

const NonInterruptingMessageStartEventIcon: React.FC<NonInterruptingMessageStartEventIconProps> = ({ name }) => (
