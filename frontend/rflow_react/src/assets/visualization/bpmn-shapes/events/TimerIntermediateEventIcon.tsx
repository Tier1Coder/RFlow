...
interface TimerIntermediateEventIconProps {
  name?: string;
}

const TimerIntermediateEventIcon: React.FC<TimerIntermediateEventIconProps> = ({ name }) => (
...
export default TimerIntermediateEventIcon;